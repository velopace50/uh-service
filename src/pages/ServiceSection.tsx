...
const ServiceSection = () => {
  ...
  const accordionData = [
    {
      header:
        'I have a sketch of my project. Can you help me figure out what I need for materials?',
  ...
  return (
    <div className="bg-white px-220 py-60 m-auto">
      <h1 className="text-center text-secondary text-32 font-normal mb-40">
        Select Your Free Service Level
      </h1>
      ...
      <div className="Build your Hardscape project with United Hardscapes">
        <h3 className="text-center text-primary text-24 font-normal">
          Build your Hardscape project with United Hardscapes
        </h3>
        <p className="text-center text-light-400 text-14 font-medium mt-20 mb-55">
          There are no limits and you can choose the level of service you want
          depending on your needs.
        </p>
        <div className="flex justify-center flex-wrap md:justify-around m-auto">
          <div
            onMouseOver={mouseOverOpacityForFirstCard}
            onMouseOut={mouseOutOpacityForFirsstCard}
            className="w-420 h-420"
          >
            <Card
              background={`${
                firstElementHover ? 'bg-primary-400' : 'bg-light-50'
              }`}
            >
              <div className="relative mt-45 mb-10">
                ...
                {firstElementHover ? (
                  ...
                  <img
                    className="absolute top-15 left-15"
                    src={QuickOrderPrimary}
                    alt="QuickOrderPrimary"
                  />
                )}
              </div>
              <h2
                className={`text-center text-32 ${
                  firstElementHover ? 'text-white' : 'text-secondary'
                } font-medium mb-20`}
              >
                Do It Yourself
              </h2>
              <div className="flex">
                <h6
                  className={`text-center text-14 ${
                    firstElementHover ? 'text-white' : 'text-primary'
                  }  font-medium mb-20 pr-10`}
                >
                  Self-Service (free)
                </h6>
                <span className="w-15 h-15">
                  <FontAwesomeIcon
                    className={`rounded-100 border-solid border-2 ${
                      firstElementHover
              ...
              <p
                className={`text-center text-14 ${
                  firstElementHover ? 'text-white' : 'text-light-400'
                } font-normal mb-30`}
              >
          ...
          <div
            onMouseOver={mouseOverOpacityForSecondCard}
            onMouseOut={mouseOutOpacityForSecondCard}
            className="w-420 h-420 mt-20 xl:mt-0"
          >
            <Card
              background={`${
                secondElementHover ? 'bg-light-50' : 'bg-primary-400'
              }`}
            >
              <div className="relative mt-45 mb-10">
                <img className="w-90 h-100" src={Vector} alt="Vector" />
              ...
              <h2
                className={`text-center text-32 ${
                  secondElementHover ? 'text-secondary' : 'text-white'
                } font-medium mb-20`}
              >
                DIY With Our Help
              </h2>
              <div className="flex">
                <h6
                  className={`text-center text-14 ${
                    secondElementHover ? 'text-primary' : 'text-white'
                  }  font-medium mb-20 pr-10`}
                >
                  AI Project Consultant (free)
                </h6>
                <span className="w-15 h-15">
                  <FontAwesomeIcon
                    className={`rounded-100 border-solid border-2 ${
              ...
              <p
                className={`text-center text-14 ${
                  secondElementHover ? 'text-light-400' : 'text-white'
                } font-normal mb-30`}
              >
                We will help you plan your DIY project.
              </p>
              <Button
                label="Get Started"
                bg_color="bg-gradient-to-r from-warning to-warning-400"
      ...
      <div className="Most Common FAQ’s">
        <h3 className="mt-70 mb-50 text-center text-32 text-primary font-normal">
          Most Common FAQ’s
        </h3>
        <div className="rounded-100">
          <TailwindAccordion data={accordionData} />
        </div>
        <h6 className="text-center text-14 text-warning font-medium my-30">
          Learn More
        </h6>
      </div>
      <div className="flex flex-col items-center  lg:flex-row lg:justify-between rounded-8 shadow-secondary bg-secondary pt-40 pb-25 pl-30">
        <div className="w-1/2">
          <h3 className="text-18 text-white font-normal">
            Want to save even more money
          </h3>
          <h2 className="text-28 text-white font-medium mb-20">
            On your hardscape project?
          </h2>
          <p className="text-12 text-white font-normal mb-35 max-w-320">
            Learn more about the other services we offer and see how you can
            save thousands of dollars by simply planning your upcoming project
            better.
          </p>
          <Button
