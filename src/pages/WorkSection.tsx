    ...
    return (
        <div className="bg-light-50 pt-130">
            <div className="relative">
                <h2 className="text-center text-32 font-normal text-primary-100">How it works</h2>
                <div className="absolute top-150 left-0 z-0">
                ...
                <div className="flex flex-wrap justify-center md:justify-evenly pb-80 relative z-20">
                    ...
                    <BlogCard>
                        <img className="w-330 h-220 object-contain" src={ReceiveEmail} alt="ReceiveEmail"/>
