    ...
    return (
        <div className="flex flex-col justify-center items-center px-50 bg-secondary lg:flex-row">
            <div className="m-auto text-32 text-white font-bold">
                ...
                <h1 className="">Marketplace <span className="font-normal">for Hardscape</span></h1>
            ...
            <div className="relative mt-35 -mb-120">
                <img className="w-435 h-395 lg:w-535 lg:h-495" src={ Vector } alt="Vector"/>
                <img className="absolute top-0 left-0 w-430 h-340 lg:w-530 lg:h-440" src={ Rectangle } alt="Rectangle" />
            </div>
        </div>
    )
}
